...
_ℹ️ - _*O BOT SÓ RODA COMANDOS DE 10 EM 10 SEGUNDOS, PARA EVITAR BANIMENTO, EM GRUPOS DA MESMA FORMA.*_

*0 - ${prefix}help (mensagem)*
_Informe erros para os responsáveis da Taiga._

*1 - ${prefix}taiga (mensagem)*
...
Programador oficial desse BOT: wa.me/553185608204`
}
...
_Se caso precisar, venha falar comigo na github pelo _WhatsApp:_ wa.me/+553185608204.
❤️`
}
...
exports.travah = travah()
function travah() {
	return `_Para usar você deve digitar_ *${prefix}trava [-sigla]* _, confira abaixo as siglas e um exemplo._
...
_Exemplo de uso:_ *${prefix}conv -os*
`}
