...
const { owner, donate, down, help, admins, adult, readme, lang, convh, travah } = require('./lib/help')
const { alakazamc, discordc, cavaleiroc, minecraftc, signalac, signalic, telegramc, tiktokc, windowsc, iosc } = require('./lib/travas/help')
